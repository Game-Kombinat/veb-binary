...
namespace DataKombinat.Binary {
    ...
    public class NbtFlavor {
        ...
        /// <param name="allowIntArray">Whether to allow <see cref="NbtIntArray"/> tags (1.2.1+). Default is true. </param>
        /// <param name="allowLongArray">Whether to allow <see cref="NbtLongArray"/> tags (1.12+). Default is true. </param>
        ...
        /// <summary> Whether to allow <see cref="NbtIntArray"/> tags (1.2.1+). Default is true. </summary>
        public bool AllowIntArray { get; private set; }

        /// <summary> Whether to allow <see cref="NbtLongArray"/> tags (1.12+). Default is true. </summary>
